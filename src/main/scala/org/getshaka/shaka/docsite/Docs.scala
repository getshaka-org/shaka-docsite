        ...
        pre:
          code{cls("scala doc-code")
            t"""override def template = Frag:
               ...
               |
               |  inline def FIXML(inline init: Element ?=> Unit)(using Element): Unit = tag("FIXML")(init)
               |
               |  FIXML { t"100 shares" }
               |"""
          }
        ...
        pre:
          code{cls("scala doc-code")
            t"""override def template = Frag:
               |  import builders.*
               |
               |  inline def radiola(inline style: String)(using Element): Unit = cssProp("border")(style)
               |
               |  p:
               |    radiola("solid")
        ...
        pre:
          code{cls("scala doc-code")
            t"""override def template = Frag:
               ...
               |
               |  p:
               |    prop("onclick")(() => js.Dynamic.global.alert("clicked!"))
               |    t"click me"
               |"""
          }
        hr{}
        ...
        pre:
          code{cls("scala doc-code")
            t"""class ClickHole extends Component:
               ...
               |
               |    button:
               |      onclick(() => numClicks.value += 1)
               |      t"click me"
               |    p:
               |      t"numClicks: $${numClicks.bind(_.toString.t)}"
               |"""
          }
        hr{}
        ClickHole().render
